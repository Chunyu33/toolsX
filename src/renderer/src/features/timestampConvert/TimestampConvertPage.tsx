      ...
      <div className="rounded-2xl border border-app-border/50 bg-app-surface/90 p-5 shadow-sm backdrop-blur-sm">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-1 text-[13px] text-app-muted/80">毫秒 / 秒 / 日期时间 互转</div>
          </div>

          <div className="flex items-center gap-2">
            <button
              className="inline-flex items-center gap-2 rounded-xl border border-app-border/60 bg-app-surface/80 px-3 py-2 text-sm text-app-text shadow-sm transition-all duration-150 hover:border-app-border hover:bg-app-surface"
              onClick={() => {
                setInput('')
              }}
              type="button"
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-app-border/40 bg-app-surface2/60 p-4 backdrop-blur-sm lg:col-span-1">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <button
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 px-3 py-2 text-sm font-medium text-white shadow-sm transition-all duration-150 hover:from-brand-600 hover:to-brand-700 hover:shadow-md whitespace-nowrap"
                onClick={() => fillNow('ms')}
                type="button"
              >
              ...
              <button
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-app-border/60 bg-app-surface/80 px-3 py-2 text-sm text-app-text shadow-sm transition-all duration-150 hover:border-brand-300/50 hover:bg-app-surface hover:shadow-md whitespace-nowrap"
                onClick={() => fillNow('s')}
                type="button"
              >
                <RefreshCcw className="h-4 w-4" />
          ...
          <div className="rounded-2xl border border-app-border/40 bg-app-surface2/60 p-4 backdrop-blur-sm lg:col-span-2">
            ...
            {!output ? (
              <div className="mt-3 rounded-xl border border-app-border/40 bg-app-surface/70 px-3 py-10 text-center text-sm text-app-muted/60">请输入时间戳</div>
            ) : (
              <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="rounded-xl border border-app-border/40 bg-app-surface/70 p-4">
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-xs font-semibold text-app-text">毫秒（ms）</div>
                    <button
                      className="inline-flex items-center gap-2 rounded-lg border border-app-border/50 bg-app-surface/80 px-2 py-1 text-xs text-app-text shadow-sm transition-all duration-150 hover:border-brand-300/50 hover:bg-app-surface hover:shadow-md"
                ...
                <div className="md:col-span-2 rounded-xl border border-app-border/40 bg-app-surface/70 p-4">
